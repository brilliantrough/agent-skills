...
missing=()
for s in grilling grill-with-docs domain-modeling tdd diagnosing-bugs code-review load-mem save-mem migrate-mem plan-brief steady-do quick-do personal-ui-taste; do
